...
import 'package:project/Options_features/Switch/switchmanager.dart';
...
class _SwitchViewState extends State<SwitchView> {
      ...
      child: Column(
        children: <Widget>[
          ...
          _buildTextFieldWith(
              ...
              currentAppState.getAppConnectionState),
          const SizedBox(height: 10),
          // _buildPublishMessageRow(),  //-------------------------------------- message sending box-------------//
          const SizedBox(height: 10),
  ...
  // Widget _buildPublishMessageRow() {    //-------------------------------------- message sending box-------------//
  //   return Row(
  ...
  Widget _buildScrollableTextWith(int text) {
    //-------------------------------- main box-------------------------//
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Container(
          ...
          width: 100,
          decoration: BoxDecoration(
              color: text < 1 ? Colors.redAccent : Colors.green,
  ...
  void _publishMessage(String text) {
    String osPrefix = 'U11234567890poiuytrewqasdfghjklm';
    if (Platform.isAndroid) {
      osPrefix = 'U2mnbvcxzasdfghjklpoiuytrewq1234';
    }
